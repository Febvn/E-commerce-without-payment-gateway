...
<section class="edit-product-form">
   ...
   <form action="" method="post" enctype="multipart/form-data">
      ...
      <input type="text" name="update_name" value="<?php echo $fetch_update['name']; ?>" class="box" required placeholder="Masukan Nama Product">
      <input type="number" min="0" name="update_cost_price" value="<?php echo $fetch_update['cost_price']; ?>" class="box" required placeholder="Masukan Modal Product">
      <input type="number" min="0" name="update_price" value="<?php echo $fetch_update['price']; ?>" class="box" required placeholder="Masukan Harga Product">
      <input type="number" min="0" name="update_quantity" value="<?php echo $fetch_update['quantity']; ?>" class="box" required placeholder="Masukan Stock Akhir">
      <input type="number" min="0" name="update_initial_stocks" value="<?php echo $fetch_update['initial_stocks']; ?>" class="box" required placeholder="Masukan Stock Awal">
      <input type="number" min="0" name="update_damaged_goods" value="<?php echo $fetch_update['damaged_goods']; ?>" class="box" required placeholder="Masukan Barang Rusak">
      <input type="number" min="0" name="update_discount_price" value="<?php echo $fetch_update['discount_price']; ?>" class="box" required placeholder="Masukan Harga Diskon">
