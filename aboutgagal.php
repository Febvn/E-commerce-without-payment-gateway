            ...
            <div class="row">
              <div class="col-lg-6">
                <ul>
                  ...
                  <li><i class="bi bi-chevron-right"></i> <strong>Website:</strong> <span>www.TokoWayKandis.com</span></li>
              ...
              <div class="col-lg-6">
                <ul>
                  ...
                  <li><i class="bi bi-chevron-right"></i> <strong>Onwers:</strong> <span>Febri</span></li>
                  <li><i class="bi bi-chevron-right"></i> <strong>Email:</strong> <span>dodithalud01@gmail.com</span></li>
                  <li><i class="bi bi-chevron-right"></i> <strong>kota:</strong> BandarLampung<span></span></li>
                </ul>
                </ul>
              </div>
            </div>
