    ...
    <d class="container-fluid position-relative d-flex align-items-center justify-content-between">
      ...
      <nav id="navmenu" class="navmenu">
        <ul>
          ...
          <li class="dropdown"><a href="shop.php" class="active"  ><span>shop</span></a>
        <!--    <li><a href="services.html">Services</a></li>-->
          <li class="dropdown"><a href="orders.php"><span>oders</span> <i class="bi bi-orders"></i></a>
        ...
        <!--  <li><a href="index.php" class="active">Home</a></li>
          ...
          <li><a href="services.html">Services</a></li>-
          <li></li><a href="search_page.php"><span>Search</span> <i class="bi bi-search"></i></a>
          <li><a href="cart.php"><span>cart</span> <i class="bi bi-cart"></i></a>
