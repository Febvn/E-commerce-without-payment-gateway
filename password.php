...
if (isset($_POST['submit'])) {
    ...
    // Define the specific email and password combination
    $admin_email = 'admin@123456789';
    $admin_password = md5('admin123456789');

    // Check if the input email and password match the predefined admin credentials
    if ($email === $admin_email && $pass === $admin_password) {
        // Set session variables for admin
        $_SESSION['admin_name'] = 'Admin'; // You can customize this or fetch real admin data
        $_SESSION['admin_email'] = $email;
        $_SESSION['admin_id'] = 1; // This could be a real user ID or any identifier

        // Update last_login timestamp in the database
        mysqli_query($conn, "UPDATE `users` SET last_login = NOW() WHERE email = '$email'") or die('query failed');
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="form-container bg-dark text-white p-5 rounded">
                            <form action="" method="post">
                                <p class="text-center">Masukan Admin Accout Utama </p>
                                <div class="mb-3">
